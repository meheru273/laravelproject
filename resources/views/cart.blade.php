                            ...
                            <tr>
                                <td>
                                    <a href="../product/details.html">
                                        <img src="{{asset('assets/images/fashion/product/front')}}/{{$product->image}}" class="img-fluid w-100 image_zoom_cls-0 blur-up lazyload" alt="{{$product->name}}" class="blur-up lazyloaded"
                                            alt="">
                                    </a>
                                </td>
                                <td>
